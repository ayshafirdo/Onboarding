...
When I attempt to add a language "English" without selecting a level
...
Given I have a language named "English" with level "Basic" in the system
    When I attempt to update the language name "English" to "Spanish"
